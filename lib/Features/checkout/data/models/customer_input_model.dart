...
//
//     final customerInputModel = customerInputModelFromJson(jsonString);

import 'dart:convert';

CustomerInputModel customerInputModelFromJson(String str) => CustomerInputModel.fromJson(json.decode(str));

String customerInputModelToJson(CustomerInputModel data) => json.encode(data.toJson());
...
class CustomerInputModel {
  ...
  factory CustomerInputModel.fromJson(Map<String, dynamic> json) => CustomerInputModel(
    id: json["id"],
    object: json["object"],
