...
EphemeralKeyModel ephemeralKeyModelFromJson(String str) =>
    EphemeralKeyModel.fromJson(json.decode(str));

String ephemeralKeyModelToJson(EphemeralKeyModel data) =>
...
class EphemeralKeyModel {
  ...
  Map<String, dynamic> toJson() => {
        "id": id,
        "object": object,
        "associated_objects": associatedObjects == null
            ? []
